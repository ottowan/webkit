...
<?PHP
	...
	echo tag_close("i");
	echo tag_open("span","","");
	echo anchor('decision', 'สืบค้นคำพิพากษาและคำสั่งของศาลแพ่ง');
	echo tag_close("span");
	echo tag_close("header");
	...
	$part_number = array(/*'p0'=>'ส่วนกลาง',
						...
						'p11'=>'ศาลพิเศษ',
						'p12'=>'ศาลชำนาญพิเศษ',*/
						'p13'=>'ศาลชั้นต้นในเขตกรุงเทพ',);
	echo form_dropdown('partnumber', $part_number, 'p13', ' id="partnumber" style="width:100%"');
	echo div_close();
	...
	$doc_type = array(""=>"","คำพิพากษา"=>"คำพิพากษา","คำสั่ง"=>"คำสั่ง");
...
*/
	...
	*/
	...
	echo form_close();		
	echo div_close();
	echo div_open("w3-col l2 error space","pdf1");
...
/*
	...
	echo div_close();
	echo div_open("w3-col l2 error space","pdf2");
	...
	echo div_close();
	echo div_open("w3-col l2 error ","pdf3");
	echo div_close();
	echo div_close();
	*/
	/*
